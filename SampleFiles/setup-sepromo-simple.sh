...
wget -O- "$ghubadd/se2lx/runse2lx.sh?raw=true" | perl -pE 's/dbname:-[^\}]*/dbname:-BearBullMole-simple.db/;s/semarkers:-[^\}]*/semarkers:-se sese/;s/inifile:-[^\}]*/inifile:-se2lx.ini/' > runse2lx-simple.sh
