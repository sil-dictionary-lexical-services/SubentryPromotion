...
#### Running "promote subentry" script
...
If you have more than one comlex form type, you will need to run the script once for each type, specifying a different "section" each time:  
